...
![Место практики в структуре подчинения кафедры](https://github.com/pupsik0053-dot/Ot4et_KAMAL/blob/main/workflow1.png)
...
### 5. Радиомонтаж: пайка электронных компонентов
...
### 6. Подключение платы LM317: описание и таблица деталей
...
![Фотография собранной платы со стабилизатором напряжения на LM317](https://github.com/pupsik0053-dot/Ot4et_KAMAL/blob/main/foto_raboty_1.jpg)
...
### 7. Разбор исходного кода flix. Первый запуск симуляции
...
### 8. Соревнование Drone Code Arena
...
### 9. Планирование полётной миссии в Mission Planner
...
### 10. Установка Linux (WSL) и развёртывание ROS
